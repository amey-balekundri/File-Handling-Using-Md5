...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            return redirect(next_page) if next_page else redirect(url_for('dashboard.dash'))
        else:
...
def account():
    ...
    if form.validate_on_submit():
        ...
        Files.query.filter_by(username=current_user.username).update(dict(username=form.username.data))
